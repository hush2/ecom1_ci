...
-- Dumping structure for table ecom1_ci.categories
...
-- Dumping data for table ecom1_ci.categories: 5 rows
...
-- Dumping structure for table ecom1_ci.favorite_pages
...
-- Dumping data for table ecom1_ci.favorite_pages: 0 rows
/*!40000 ALTER TABLE `favorite_pages` DISABLE KEYS */;
/*!40000 ALTER TABLE `favorite_pages` ENABLE KEYS */;


-- Dumping structure for table ecom1_ci.history
...
-- Dumping data for table ecom1_ci.history: 0 rows
/*!40000 ALTER TABLE `history` DISABLE KEYS */;
/*!40000 ALTER TABLE `history` ENABLE KEYS */;


-- Dumping structure for table ecom1_ci.pages
...
-- Dumping data for table ecom1_ci.pdfs: 4 rows
...
INSERT IGNORE INTO `pdfs` (`id`, `tmp_name`, `title`, `description`, `file_name`, `size`, `date_created`) VALUES
	(1, '7f3fa67294ccca0d62ea4fcf59660451', 'Javascript Cheat Sheet', 'Javascript Cheat Sheet v1', 'javascript-cheat-sheet-v1.pdf', 453, '2012-09-06 13:36:05'),
	(2, 'c268b1aa4b475998d0a4eaef14eaabdb', 'mod_rewrite Cheat Sheet', 'mod_rewrite Cheat Sheet v2', 'mod_rewrite-cheat-sheet-v2.pdf', 563, '2012-09-06 13:36:17'),
	(3, '3c3af071fffe35d59ab8cbe667c11b2d', 'MySQL Cheat Sheet', 'MySQL Cheat Sheet v1', 'mysql-cheat-sheet-v1.pdf', 347, '2012-09-06 13:36:44'),
	(4, '3abc6b28648ae3be8efb683098a9a94c', 'PHP Cheat Sheet', 'PHP Cheat Sheet v2', 'php-cheat-sheet-v2.pdf', 543, '2012-09-06 13:36:54');
/*!40000 ALTER TABLE `pdfs` ENABLE KEYS */;


-- Dumping structure for table ecom1_ci.users
...
-- Dumping data for table ecom1_ci.users: 1 rows
...
INSERT IGNORE INTO `users` (`id`, `type`, `username`, `email`, `pass`, `first_name`, `last_name`, `date_expires`, `date_created`, `date_modified`) VALUES
	(1, 'admin', 'admin', 'admin@example.com', _binary 0x99F4D019523960B5F0F4D76B8A3304D89535542A930B3726B2D43E7BDFBA8927, 'admin', 'admin', '2012-10-05', '2012-09-05 15:15:37', '2012-09-05 18:48:48'),
	(2, 'member', 'demo', 'demo@example.com', _binary 0x99F4D019523960B5F0F4D76B8A3304D89535542A930B3726B2D43E7BDFBA8927, 'demo', 'demo', '2012-10-06', '2012-09-06 13:39:24', '0000-00-00 00:00:00'),
	(3, 'member', 'demo2', 'demo2@example.com', _binary 0x99F4D019523960B5F0F4D76B8A3304D89535542A930B3726B2D43E7BDFBA8927, 'demo', 'demo', '2012-08-06', '2012-09-06 13:39:47', '0000-00-00 00:00:00');
